...
//This is almost directly copied from ChargedUp except for the controller types
public class ControlScheme {
     public static final GameController.Type OPERATOR_CONTROLLER_TYPE = GameController.Type.PS5;
    public static final GameController.Type DRIVER_CONTROLLER_TYPE   = GameController.Type.PS5;
    public static final GameController.Type DEBUG_CONTROLLER_TYPE   = GameController.Type.PS4;
